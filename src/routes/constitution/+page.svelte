...
<div class="constitution">
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $1000. $0 bids are allowed. Bids will process on Wednesdays.</p>
    ...
    <p>The draft order each year will be selected through pulling names and draft position from 2 hats.</p>
    ...
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical Full 1 pt PPR Scoring). The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. Playoff spots will be awarded to the top 6 teams per that season. The top 2 teams will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
